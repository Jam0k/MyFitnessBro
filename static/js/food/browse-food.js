$(document).ready(function () {
    ...
    $('#browseFoodModal').on('shown.bs.modal', function () {
        // Initialize DataTables for the table inside the modal
        // Check if it's not already initialized
        if (!$.fn.DataTable.isDataTable('#browseFoodModal .table')) {
            $('#browseFoodModal .table').DataTable();
        }
    });
